# Summit-Toolbox.psd1
# Module manifest for Summit-Toolbox

@{
    # Script module or binary module file associated with this manifest.
    RootModule = 'Summit-Toolbox.psm1'
    ...
    Author = 'Summit 2026 Participant'

    # Company or vendor of this module
    CompanyName = 'Summit 2026'

    # Copyright statement for this module
    Copyright = '(c) 2026 Summit 2026. All rights reserved.'

    # Description of the functionality provided by this module
    Description = 'A PowerShell module containing tools for Summit 2026 Toolmaking.'
    ...
    FunctionsToExport = @('Get-SummitGreeting', 'Update-SummitService', 'Get-SummitOfficeUser', 'New-SummitUser', 'Get-BasicCommand', 'Invoke-Nonsense')
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            Tags = @('Summit', 'Toolbox', 'PowerShell')
